...
binname2="wrf.exe"
#binname="tc.exe"
rundir="/pscratch/sd/h/hross/simulation/WRF/seabreeze_Hannah" #user needs to change this
...
#get ics
srun -n 1 -c 4 --cpu_bind=cores ${bindir}/${binname}
...
#run simulation
srun -n 1 -c 4 --cpu_bind=cores ${bindir}/${binname2}
